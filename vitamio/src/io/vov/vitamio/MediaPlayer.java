...
public class MediaPlayer {
     ...
     * </p>
     *
     * @param preferHWDecoder
     *         MediaPlayer will try to use hardware accelerated decoder if true
     */
     ...
     *
     * @param path
     *         the path of the file, or the http/rtsp URL of the stream you want
     *         to play
     ...
     *
     * @param path
     *         the path of the file, or the http/rtsp/mms URL of the stream you
     *         want to play
     * @param keys
     *         AVOption key
     * @param values
    ...
    public interface OnBufferingUpdateListener {
         ...
         * @param percent
         *         the percentage (0-100) of the buffer that has been filled thus
         *         far
         */
    ...
    public interface OnErrorListener {
         ...
         *         </ul>
         * @param extra
         *         an extra code, specific to the error. Typically implementation
         *         dependant.
    ...
    public interface OnInfoListener {
         ...
         *         </ul>
         * @param extra
         *         an extra code, specific to the info. Typically implementation
         *         dependant.
