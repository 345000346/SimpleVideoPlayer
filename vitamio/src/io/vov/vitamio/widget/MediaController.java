...
public class MediaController extends FrameLayout {
    ...
    private void initControllerView(View v) {
        ...
        mDownSpeed = (TextView) v.findViewById(getResources().getIdentifier("mediacontroller_down_speed", "id", mContext.getPackageName()));
        if (mFileName != null)
     ...
     *         animation style to use when the controller appears
    ...
    public void setProgressEnabled(boolean progressEnabled) {
        if (mProgress != null)
            mProgress.setEnabled(progressEnabled);
    }
